...
namespace effcore {
  ...
  static function datetime_t_natv_to_global($datetime, $native_format = true) {$date = \DateTime::createFromFormat($native_format ? static::settings_get()->format_datetime : 'Y-m-d\\TH:i:s', $datetime, new \DateTimeZone(core::timezone_client_get())); if ($date) return $date->setTimezone( new \DateTimeZone('UTC') )->format( 'Y-m-d H:i:s' );}
  ...
  static function datetime_global_to_t_natv($datetime, $native_format = true) {$date = \DateTime::createFromFormat('Y-m-d H:i:s', $datetime, new \DateTimeZone('UTC')); if ($date) return $date->setTimezone( new \DateTimeZone(core::timezone_client_get()) )->format( $native_format ? static::settings_get()->format_datetime : 'Y-m-d\\TH:i:s' );}
