...
namespace effcore {
  ...
  static function     date_native_to_global($date,     $native_format = true) {$date = \DateTime::createFromFormat($native_format ? static::settings_get()->format_date     : 'Y-m-d'      ,     $date, new \DateTimeZone(core::timezone_client_get())); if ($date) return $date->setTimezone( new \DateTimeZone('UTC') )->format( 'Y-m-d'       );}
  ...
  static function     date_global_to_native($date,     $native_format = true) {$date = \DateTime::createFromFormat('Y-m-d',           $date, new \DateTimeZone('UTC')); if ($date) return $date->setTimezone( new \DateTimeZone(core::timezone_client_get()) )->format( $native_format ? static::settings_get()->format_date     : 'Y-m-d'       );}
