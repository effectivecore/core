...
namespace effcore {
  ...
  static function datetime_T_utc_to_T_loc($datetime) {$date = \DateTime::createFromFormat('Y-m-d\\TH:i:s', $datetime, new \DateTimeZone('UTC') ); if ($date) return $date->setTimezone( new \DateTimeZone(core::timezone_client_get()) )->format('Y-m-d\\TH:i:s');}
  static function   datetime_utc_to_T_utc($datetime) {$date = \DateTime::createFromFormat('Y-m-d H:i:s',   $datetime, new \DateTimeZone('UTC') ); if ($date) return $date->                                                               format('Y-m-d\\TH:i:s');}
