  ...
  static function on_show_block_menu_languages($page) {
    ...
    foreach ($languages as $c_language) {
      ...
      if (url::is_active($c_href))
           $c_link = new markup('a', ['href' => $c_href, 'title' => translation::get('go to %%_title language', ['title' => $c_language->title_en], 'en'), 'aria-selected' => 'true'], $c_title);
      else $c_link = new markup('a', ['href' => $c_href, 'title' => translation::get('go to %%_title language', ['title' => $c_language->title_en], 'en')                           ], $c_title);
