...
namespace effcore {
  ...
  static function id_get_hex_uagent_hash_8()   {return core::mini_get_hash(core::server_get_user_agent(80));} # note: why 80? when you add a page to your favourites in Safari the browser sends a user-agent header with a shorter string length than usual
