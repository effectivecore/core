...
class Events_Test__JS {
    ...
    static test_step_code__Array_isArray(test, dpath, c_results) {
        let data = {
            ...
            'document'         : Array.isArray( document.all      ) === false
        };
    ...
    static test_step_code__Object_toString(test, dpath, c_results) {
        let data = {
            ...
            'document'         : Object.prototype.toString.call( document.all      ) === '[object HTMLAllCollection]'
        };
    ...
    static test_step_code__Effcore_getType(test, dpath, c_results) {
        let data = {
            ...
            'document'         : Effcore.getType( document.all      ) === 'HTMLAllCollection'
        };
