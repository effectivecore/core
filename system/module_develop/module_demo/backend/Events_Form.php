  ...
  static function on_submit_demo($form, $items) {
    ...
    switch ($form->clicked_button_name) {
      case 'submit':
        ...
        if ($items['#checkboxes:checkboxes_1']->checked_get() != false)     message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#checkboxes:checkboxes_1']->title)]));     # effcore\field_checkbox
        if ($items['#checkboxes:checkboxes_2']->checked_get() != true)      message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#checkboxes:checkboxes_2']->title)]));     # effcore\field_checkbox
        if ($items['#checkboxes:checkboxes_3']->checked_get() != false)     message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#checkboxes:checkboxes_3']->title)]));     # effcore\field_checkbox
        if ($items['#checkboxes:checkboxes_4']->checked_get() != true)      message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#checkboxes:checkboxes_4']->title)]));     # effcore\field_checkbox
        ...
        if ($items['#radiobuttons:radiobuttons_1']->checked_get() != false) message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#radiobuttons:radiobuttons_1']->title)])); # effcore\field_radiobutton
        if ($items['#radiobuttons:radiobuttons_2']->checked_get() != true)  message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#radiobuttons:radiobuttons_2']->title)])); # effcore\field_radiobutton
        if ($items['#radiobuttons:radiobuttons_3']->checked_get() != false) message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#radiobuttons:radiobuttons_3']->title)])); # effcore\field_radiobutton
