  ...
  static function on_submit_demo($form, $items) {
    ...
    switch ($form->clicked_button->value_get()) {
      case 'submit':
        ...
        if ($items['#checkbox']->element_checked_get() != true)           message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#checkbox']->title)]));        # effcore\field_checkbox
        if ($items['#checkboxes'][0]->element_checked_get() != false)     message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#checkboxes'][0]->title)]));   # effcore\field_checkbox
        if ($items['#checkboxes'][1]->element_checked_get() != true)      message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#checkboxes'][1]->title)]));   # effcore\field_checkbox
        if ($items['#checkboxes'][2]->element_checked_get() != false)     message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#checkboxes'][2]->title)]));   # effcore\field_checkbox
        if ($items['#checkboxes'][3]->element_checked_get() != true)      message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#checkboxes'][3]->title)]));   # effcore\field_checkbox
        if ($items['#radiobutton']->element_checked_get() != false)       message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#radiobutton']->title)]));     # effcore\field_radiobutton
        if ($items['#radiobuttons'][0]->element_checked_get() != false)   message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#radiobuttons'][0]->title)])); # effcore\field_radiobutton
        if ($items['#radiobuttons'][1]->element_checked_get() != true)    message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#radiobuttons'][1]->title)])); # effcore\field_radiobutton
        if ($items['#radiobuttons'][2]->element_checked_get() != false)   message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#radiobuttons'][2]->title)])); # effcore\field_radiobutton
