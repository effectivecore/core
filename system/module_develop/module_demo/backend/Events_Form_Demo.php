  ...
  static function on_submit($form, $items) {
    ...
    switch ($form->clicked_button->value_get()) {
      case 'submit':
        ...
        if ($items['#relation'       ]->value_get  ()      != '1'                  ) message::insert( new text('Field "%%_title" has a changed value.', ['title' => translation::get($items['#relation'       ]->title)]) ); # …\field_relation
        if ($items['#relation_tree'  ]->value_get  ()      != '1'                  ) message::insert( new text('Field "%%_title" has a changed value.', ['title' => translation::get($items['#relation_tree'  ]->title)]) ); # …\field_relation
