  ...
  static function on_submit($form, $items) {
    ...
    switch ($form->clicked_button->value_get()) {
      case 'submit':
        ...
        if ($items['#switcher']->checked_get() != true)                   message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#switcher']->title)]));        # effcore\field_switcher
        if ($items['#switchers'][0]->checked_get() != false)              message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#switchers'][0]->title)]));    # effcore\field_switchers
        if ($items['#switchers'][1]->checked_get() != true)               message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#switchers'][1]->title)]));    # effcore\field_switchers
        if ($items['#switchers'][2]->checked_get() != false)              message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#switchers'][2]->title)]));    # effcore\field_switchers
        if ($items['#switchers'][3]->checked_get() != true)               message::insert(translation::get('Field "%%_title" has a changed value.', ['title' => translation::get($items['#switchers'][3]->title)]));    # effcore\field_switchers
