  ...
  static function on_submit($event, $form, $items) {
    switch ($form->clicked_button->value_get()) {
      case 'send':
        ...
        if (md5($items['#textarea_data']->value_get()) !== 'c616bb480b061e5dad22f38b04d9a297') message::insert( new text('Field "%%_title" has a changed value.', ['title' => (new text($items['#textarea_data'  ]->title))->render() ]) ); # …\field_textarea_data
