  ...
  static function on_submit($event, $form, $items) {
    ...
    switch ($form->clicked_button->value_get()) {
      case 'send':
        ...
        if ($items['#nickname'       ]->value_get  ()       != 'user'                    ) message::insert( new text('Field "%%_title" has a changed value.', ['title' => translation::get($items['#nickname'       ]->title)]) ); # …\field_nickname
        ...
        if ($items['#select_multiple']->values_get ()       != $def_value_select_multiple) message::insert( new text('Field "%%_title" has a changed value.', ['title' => translation::get($items['#select_multiple']->title)]) ); # …\field_select
        ...
        if ($items['#textarea'       ]->value_get  ()       != 'text in text area'       ) message::insert( new text('Field "%%_title" has a changed value.', ['title' => translation::get($items['#textarea'       ]->title)]) ); # …\field_textarea
        ...
        if ($items['*access'         ]->value_get_complex() != []                        ) message::insert( new text('Group "%%_title" has a changed value.', ['title' => translation::get($items['*access'         ]->title)]) ); # …\widget_access
