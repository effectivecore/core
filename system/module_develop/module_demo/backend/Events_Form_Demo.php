  ...
  static function on_submit($form, $items) {
    ...
    switch ($form->clicked_button->value_get()) {
      case 'submit':
        ...
        if ($items['#password']->value_get() != 'text in password')          message::insert( new text('Field "%%_title" has a changed value.', ['title' => translation::get($items['#password']->title)])        ); # …\field_password
        ...
        if ($items['#phone']->value_get() != '+000112334455')                message::insert( new text('Field "%%_title" has a changed value.', ['title' => translation::get($items['#phone']->title)])           ); # …\field_phone
