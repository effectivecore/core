...
namespace effcore\modules\demo {
  ...
  static function on_tree_demo_do_dynamic_changes($page) {
    tree::item_insert('item #1.2.3 (from code)', 'demo_item_1_2_3', 'demo_item_1_2', '/develop/demo/embedded/trees/item_1/item_1_2/item_1_2_3', ['class' => ['demo-item-1-2-3' => 'demo-item-1-2-3']]);
    tree::item_insert('item #3 (from code)',     'demo_item_3',     'M:demo',        '/develop/demo/embedded/trees/item_3',                     ['class' => ['demo-item-3'     => 'demo-item-3'    ]]);
  }
