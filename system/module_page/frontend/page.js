...
/* audio */
  ...
  document.effQuerySelectorAll('audio[data-player-name="default"]').forEach(function(c_audio){
    ...
    c_audio.addEventListener('pause',          function(){c_button_play.removeAttribute('data-is-playing');      }, false);
    c_audio.addEventListener('play',           function(){c_button_play.setAttribute   ('data-is-playing', true);}, false);
