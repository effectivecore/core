    ...
    document.querySelectorAll('x-widgets-group[data-rearrangeable]').forEach(function (c_rearrangeable_group) {
        ...
        c_rearrangeable_group.querySelectorAll('[data-rearrangeable-item]').forEach(function (c_rearrangeable) {
            ...
            let draggable_icon = c_rearrangeable.querySelector('x-icon');
                ...
                draggable_icon.addEventListener('dragstart', function (event) { window._effDataTransferNode = this; c_rearrangeable_group.   setAttribute('data-rearrangeable-is-active', ''); c_rearrangeable.   setAttribute('data-rearrangeable-is-active', ''); });
                draggable_icon.addEventListener('dragend'  , function (event) { window._effDataTransferNode = null; c_rearrangeable_group.removeAttribute('data-rearrangeable-is-active'    ); c_rearrangeable.removeAttribute('data-rearrangeable-is-active'    ); });
