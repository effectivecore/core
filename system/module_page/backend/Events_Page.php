    ...
    if (access::check((object)['roles' => ['registered' => 'registered']])) {
      if ($page->origin === 'sql' || $page->origin === 'hybrid') {
        if (access::check((object)[
          ...
          if ($edit_mode !== 'true'                                                     ) $admin_actions->child_insert(new markup('a', ['data-id' => 'manage-enter', 'title' => new text('enter edit mode'), 'href' => $url->tiny_get()], 'enter edit mode'), 'manage_layout');
          if ($edit_mode === 'true'                                                     ) $admin_actions->child_insert(new markup('a', ['data-id' => 'manage-leave', 'title' => new text('leave edit mode'), 'href' => $url->tiny_get()], 'leave edit mode'), 'manage_layout');
