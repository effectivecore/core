...
namespace effcore\modules\page {
  ...
  static function on_block_presets_dynamic_build($event, $id = null) {
    if ($id === null                                             ) {foreach (entity::get('audio'  )->instances_select() as $c_item)  block_preset::insert('block__'.  'audio_sql__'.$c_item->id, 'Audios',    $c_item->description ?: 'NO TITLE', [ /* all areas */ ], ['type' => 'code', 'source' => '\\effcore\\modules\\page\\events_page::block_markup__selection_make', 'args' => ['instance_id' => $c_item->id, 'entity_name' => 'audio'  ], 'has_admin_menu' => true, 'attributes' => ['data-section' => true, 'data-id' => 'block__'.  'audio_sql__'.$c_item->id]], 0, 'page');}
    if ($id === null                                             ) {foreach (entity::get('gallery')->instances_select() as $c_item)  block_preset::insert('block__'.'gallery_sql__'.$c_item->id, 'Galleries', $c_item->title       ?: 'NO TITLE', [ /* all areas */ ], ['type' => 'code', 'source' => '\\effcore\\modules\\page\\events_page::block_markup__selection_make', 'args' => ['instance_id' => $c_item->id, 'entity_name' => 'gallery'], 'has_admin_menu' => true, 'attributes' => ['data-section' => true, 'data-id' => 'block__'.'gallery_sql__'.$c_item->id]], 0, 'page');}
    if ($id === null                                             ) {foreach (entity::get('picture')->instances_select() as $c_item)  block_preset::insert('block__'.'picture_sql__'.$c_item->id, 'Pictures',  $c_item->description ?: 'NO TITLE', [ /* all areas */ ], ['type' => 'code', 'source' => '\\effcore\\modules\\page\\events_page::block_markup__selection_make', 'args' => ['instance_id' => $c_item->id, 'entity_name' => 'picture'], 'has_admin_menu' => true, 'attributes' => ['data-section' => true, 'data-id' => 'block__'.'picture_sql__'.$c_item->id]], 0, 'page');}
    if ($id === null                                             ) {foreach (entity::get('text'   )->instances_select() as $c_item)  block_preset::insert('block__'.   'text_sql__'.$c_item->id, 'Texts',     $c_item->description ?: 'NO TITLE', [ /* all areas */ ], ['type' => 'code', 'source' => '\\effcore\\modules\\page\\events_page::block_markup__selection_make', 'args' => ['instance_id' => $c_item->id, 'entity_name' => 'text'   ], 'has_admin_menu' => true, 'attributes' => ['data-section' => true, 'data-id' => 'block__'.   'text_sql__'.$c_item->id]], 0, 'page');}
    if ($id === null                                             ) {foreach (entity::get('video'  )->instances_select() as $c_item)  block_preset::insert('block__'.  'video_sql__'.$c_item->id, 'Videos',    $c_item->description ?: 'NO TITLE', [ /* all areas */ ], ['type' => 'code', 'source' => '\\effcore\\modules\\page\\events_page::block_markup__selection_make', 'args' => ['instance_id' => $c_item->id, 'entity_name' => 'video'  ], 'has_admin_menu' => true, 'attributes' => ['data-section' => true, 'data-id' => 'block__'.  'video_sql__'.$c_item->id]], 0, 'page');}
    ...
    if ($id !== null && strpos($id, 'block__'.'gallery_sql__') === 0) {$c_item__id = substr($id, strlen('block__'.'gallery_sql__')); block_preset::insert('block__'.'gallery_sql__'.$c_item__id, 'Galleries',                         'NO TITLE', [ /* all areas */ ], ['type' => 'code', 'source' => '\\effcore\\modules\\page\\events_page::block_markup__selection_make', 'args' => ['instance_id' => $c_item__id, 'entity_name' => 'gallery'], 'has_admin_menu' => true, 'attributes' => ['data-section' => true, 'data-id' => 'block__'.'gallery_sql__'.$c_item__id]], 0, 'page');}
    if ($id !== null && strpos($id, 'block__'.'picture_sql__') === 0) {$c_item__id = substr($id, strlen('block__'.'picture_sql__')); block_preset::insert('block__'.'picture_sql__'.$c_item__id, 'Pictures',                          'NO TITLE', [ /* all areas */ ], ['type' => 'code', 'source' => '\\effcore\\modules\\page\\events_page::block_markup__selection_make', 'args' => ['instance_id' => $c_item__id, 'entity_name' => 'picture'], 'has_admin_menu' => true, 'attributes' => ['data-section' => true, 'data-id' => 'block__'.'picture_sql__'.$c_item__id]], 0, 'page');}
    if ($id !== null && strpos($id, 'block__'.   'text_sql__') === 0) {$c_item__id = substr($id, strlen('block__'.   'text_sql__')); block_preset::insert('block__'.   'text_sql__'.$c_item__id, 'Texts',                             'NO TITLE', [ /* all areas */ ], ['type' => 'code', 'source' => '\\effcore\\modules\\page\\events_page::block_markup__selection_make', 'args' => ['instance_id' => $c_item__id, 'entity_name' => 'text'   ], 'has_admin_menu' => true, 'attributes' => ['data-section' => true, 'data-id' => 'block__'.   'text_sql__'.$c_item__id]], 0, 'page');}
    if ($id !== null && strpos($id, 'block__'.  'video_sql__') === 0) {$c_item__id = substr($id, strlen('block__'.  'video_sql__')); block_preset::insert('block__'.  'video_sql__'.$c_item__id, 'Videos',                            'NO TITLE', [ /* all areas */ ], ['type' => 'code', 'source' => '\\effcore\\modules\\page\\events_page::block_markup__selection_make', 'args' => ['instance_id' => $c_item__id, 'entity_name' => 'video'  ], 'has_admin_menu' => true, 'attributes' => ['data-section' => true, 'data-id' => 'block__'.  'video_sql__'.$c_item__id]], 0, 'page');}
  }
