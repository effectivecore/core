...
namespace effcore\modules\page {
  ...
  static function on_submit($event, $form, $items) {
    switch ($form->clicked_button->value_get()) {
      case 'save':
        $selected = [];
        $selected['color_page_id'                  ] = $items['*color_page_id'                  ]->value_get();
        $selected['color_text_id'                  ] = $items['*color_text_id'                  ]->value_get();
        $selected['color_main_id'                  ] = $items['*color_main_id'                  ]->value_get();
        $selected['color_link_id'                  ] = $items['*color_link_id'                  ]->value_get();
        $selected['color_link_active_id'           ] = $items['*color_link_active_id'           ]->value_get();
        $selected['color_table_row_odd_id'         ] = $items['*color_table_row_odd_id'         ]->value_get();
        $selected['color_table_row_even_id'        ] = $items['*color_table_row_even_id'        ]->value_get();
        $selected['color_relation_id'              ] = $items['*color_relation_id'              ]->value_get();
        $selected['color_menu_id'                  ] = $items['*color_menu_id'                  ]->value_get();
        $selected['color_menu_active_id'           ] = $items['*color_menu_active_id'           ]->value_get();
        $selected['color_menu_text_id'             ] = $items['*color_menu_text_id'             ]->value_get();
        $selected['color_menu_link_id'             ] = $items['*color_menu_link_id'             ]->value_get();
        $selected['color_menu_link_active_id'      ] = $items['*color_menu_link_active_id'      ]->value_get();
        $selected['color_tabs_id'                  ] = $items['*color_tabs_id'                  ]->value_get();
        $selected['color_tabs_link_id'             ] = $items['*color_tabs_link_id'             ]->value_get();
        $selected['color_tabs_link_active_id'      ] = $items['*color_tabs_link_active_id'      ]->value_get();
        $selected['color_tabs_link_active_no_bg_id'] = $items['*color_tabs_link_active_no_bg_id']->value_get();
        $selected['color_ok_id'                    ] = $items['*color_ok_id'                    ]->value_get();
        $selected['color_warning_id'               ] = $items['*color_warning_id'               ]->value_get();
        $selected['color_error_id'                 ] = $items['*color_error_id'                 ]->value_get();
        $selected['color_fieldset_id'              ] = $items['*color_fieldset_id'              ]->value_get();
        $selected['color_fieldset_nested_id'       ] = $items['*color_fieldset_nested_id'       ]->value_get();
        $selected['color_field_id'                 ] = $items['*color_field_id'                 ]->value_get();
        $selected['color_field_text_id'            ] = $items['*color_field_text_id'            ]->value_get();
        $selected['color_button_id'                ] = $items['*color_button_id'                ]->value_get();
        $selected['color_button_active_id'         ] = $items['*color_button_active_id'         ]->value_get();
        $selected['color_button_text_id'           ] = $items['*color_button_text_id'           ]->value_get();
