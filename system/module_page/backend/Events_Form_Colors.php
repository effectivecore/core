  ...
  static function on_submit($event, $form, $items) {
    switch ($form->clicked_button->value_get()) {
      case 'save':
        ...
        storage::get('files')->changes_insert('page', 'update', 'settings/page/color_tabs_link_active_no_bg_id', $items['*color_tabs_link_active_no_bg_id']->value_get(), false);
      ...
      case 'reset':
        ...
        storage::get('files')->changes_delete('page', 'update', 'settings/page/color_tabs_link_active_no_bg_id', false);
