  ...
  # validate each item
    ...
    foreach ($new_values as $c_new_value) {
      ...
      switch ($c_new_value->error) {
        ...
        case UPLOAD_ERR_CANT_WRITE: $field->error_set(new text_multiline(['Field "%%_title" contains an error!', 'File cannot be written to disc!'                                                   ], ['title' => (new text($field->title))->render()                                            ])); return;
