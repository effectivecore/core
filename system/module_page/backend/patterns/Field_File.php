...
# ─────────────────────────────────────────────────────────────────────
  ...
  public $characters_allowed_for_name = '"a-z", "A-Z", "0-9", "_", "-", "."';
  ...
  function render_description() {
    ...
    if ($this->characters_allowed_for_name) $this->description[] = $this->render_description_file_name_characters_allowed();
  ...
  function render_description_file_name_characters_allowed() {return new markup('p', ['data-id' => 'file-allowed-characters'], new text('File name can contain only the next characters: %%_characters',      ['characters' =>               $this->characters_allowed_for_name]));}
