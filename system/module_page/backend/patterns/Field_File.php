...
# ─────────────────────────────────────────────────────────────────────
  ...
  public $characters_allowed_in_name = '"a-z", "A-Z", "0-9", "_", "-", "."';
  ...
  function render_description() {
    ...
    if ($this->characters_allowed_in_name) $this->description[] = $this->render_description_file_characters_allowed_in_name();
  ...
  function render_description_file_characters_allowed_in_name() {return new markup('p', ['data-id' => 'file-allowed-characters'], new text('File name can contain only the next characters: %%_characters',      ['characters' =>               $this->characters_allowed_in_name]));}
