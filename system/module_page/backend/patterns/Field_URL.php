...
namespace effcore {
  ...
  static function validate_value($field, $form, $element, &$new_value) {
    ...
    if (strlen($new_value) && isset($field->should_be_excluded['protocol']) && $raw_url->protocol !== '') {$field->error_set('Field "%%_title" should not contain protocol!', ['title' => (new text($field->title))->render() ]); return;}
    if (strlen($new_value) && isset($field->should_be_excluded['domain'  ]) && $raw_url->domain   !== '') {$field->error_set('Field "%%_title" should not contain domain!',   ['title' => (new text($field->title))->render() ]); return;}
    if (strlen($new_value) && isset($field->should_be_excluded['path'    ]) && $raw_url->path     !== '') {$field->error_set('Field "%%_title" should not contain path!',     ['title' => (new text($field->title))->render() ]); return;}
    if (strlen($new_value) && isset($field->should_be_excluded['query'   ]) && $raw_url->query    !== '') {$field->error_set('Field "%%_title" should not contain query!',    ['title' => (new text($field->title))->render() ]); return;}
    if (strlen($new_value) && isset($field->should_be_excluded['anchor'  ]) && $raw_url->anchor   !== '') {$field->error_set('Field "%%_title" should not contain anchor!',   ['title' => (new text($field->title))->render() ]); return;}
    if (strlen($new_value) && isset($field->should_be_included['protocol']) && $raw_url->protocol === '') {$field->error_set('Field "%%_title" should contain protocol!',     ['title' => (new text($field->title))->render() ]); return;}
    if (strlen($new_value) && isset($field->should_be_included['domain'  ]) && $raw_url->domain   === '') {$field->error_set('Field "%%_title" should contain domain!',       ['title' => (new text($field->title))->render() ]); return;}
    if (strlen($new_value) && isset($field->should_be_included['path'    ]) && $raw_url->path     === '') {$field->error_set('Field "%%_title" should contain path!',         ['title' => (new text($field->title))->render() ]); return;}
    if (strlen($new_value) && isset($field->should_be_included['query'   ]) && $raw_url->query    === '') {$field->error_set('Field "%%_title" should contain query!',        ['title' => (new text($field->title))->render() ]); return;}
    if (strlen($new_value) && isset($field->should_be_included['anchor'  ]) && $raw_url->anchor   === '') {$field->error_set('Field "%%_title" should contain anchor!',       ['title' => (new text($field->title))->render() ]); return;}
    return true;
  }
