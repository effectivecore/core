      ...
      case 'insert':
        ...
        foreach ($entity->fields as $c_name => $c_field) {
          ...
          if ($form->_instance->insert())
               message::insert(new text('Item of type "%%_name" with id = "%%_id" was inserted.',     ['name' => translation::get($entity->title), 'id' => implode('+', $entity->id_get_from_values($form->_instance->values_get())) ])           );
