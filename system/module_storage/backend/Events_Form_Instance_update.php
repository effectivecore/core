      ...
      if (count($id_keys) ==
        ...
        # make fields for managing
          ...
          foreach ($entity->fields as $c_name => $c_field) {
            if (!empty($c_field->managing_is_on_update) && isset($c_field->managing_form_class)) {
              ...
              $c_form_field->element_attributes = ($c_field->managing_element_attributes_on_update ?? []) + $c_form_field->element_attributes;
