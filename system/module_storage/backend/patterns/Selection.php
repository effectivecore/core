            ...
            foreach ($this->fields as $c_field) {
              switch ($c_field->type) {
                ...
                case 'field':
                  ...
                  if ($c_type == 'date')     $c_value = locale::    date_global_to_native($c_value);
                  if ($c_type == 'time')     $c_value = locale::    time_global_to_native($c_value);
                  if ($c_type == 'datetime') $c_value = locale::datetime_global_to_native($c_value);
