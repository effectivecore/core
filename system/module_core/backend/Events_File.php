          ...
          if ($file_thumb->is_exist()) {
            ...
            if (extension_loaded('exif') && extension_loaded('gd')) {
              ...
              if ($result) {
                $file = $file_thumb;
                return;
              } else {$file = new file(dir_system.'module_core/frontend/pictures/media-error-extensions-not-loaded'   ); return;}
            }   else {$file = new file(dir_system.'module_core/frontend/pictures/media-error-thumbnail-creation-error'); return;}
          }
        } else {
