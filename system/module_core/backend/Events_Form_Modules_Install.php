  ...
  static function on_init($form, $items) {
    ...
    foreach ($modules_by_groups as $c_modules) {
      foreach ($c_modules as $c_module) {
        ...
        $c_switcher->attribute_insert('title', translation::get('Press to select module %%_title to be enabled or disabled', ['title' => $c_module->title]), 'element_attributes');
        $c_switcher->build();
        ...
        $c_info->child_insert($c_switcher, 'switcher');
                                                         $c_info->child_insert(new markup('x-module-title',        [],              [new markup('x-label', ['hidden' => 'true'], 'title'   ), new markup('x-value', [],                        $c_module->title              )]), 'title'           );
