    ...
    foreach ($modules_by_groups as $c_modules) {
      foreach ($c_modules as $c_module) {
        ...
        $c_info->child_insert($c_switcher, 'switcher');
                                                                $c_info->child_insert(new markup('x-param', ['data-type' => 'title'             ], [new markup('x-label', ['aria-hidden' => 'true'], 'title'                     ), new markup('x-value', [],                        $c_module->title                  )]), 'title'             );
                                                                $c_info->child_insert(new markup('x-param', ['data-type' => 'id'                ], [new markup('x-label', [                       ], 'id'                        ), new markup('x-value', [],        new text_simple($c_module->id)                    )]), 'id'                );
                                                                $c_info->child_insert(new markup('x-param', ['data-type' => 'version'           ], [new markup('x-label', [                       ], 'version'                   ), new markup('x-value', [], locale::format_version($c_module->version)               )]), 'version'           );
                                                                $c_info->child_insert(new markup('x-param', ['data-type' => 'is-embed'          ], [new markup('x-label', [                       ], 'is embed'                  ), new markup('x-value', [],           isset($embed[$c_module->id]) ? 'yes' : 'no'    )]), 'is_embed'          );
